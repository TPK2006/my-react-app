          ...
          <li>
            <button className="nav-button active">
              <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M10.25 13.75V11.5H7.25V4H5.75V6.25H0.5V0.25H5.75V2.5H10.25V0.25H15.5V6.25H10.25V4H8.75V10H10.25V7.75H15.5V13.75H10.25Z"
                  fill="white"
                />
              </svg>
              Match flow
          ...
          <li>
            <button className="nav-button">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M1.75 13.75C1.3375 13.75 0.984375 13.6031 0.690625 13.3094C0.396875 13.0156 0.25 12.6625 0.25 12.25V1.75C0.25 1.3375 0.396875 0.984375 0.690625 0.690625C0.984375 0.396875 1.3375 0.25 1.75 0.25H12.25C12.6625 0.25 13.0156 0.396875 13.3094 0.690625C13.6031 0.984375 13.75 1.3375 13.75 1.75V12.25C13.75 12.6625 13.6031 13.0156 13.3094 13.3094C13.0156 13.6031 12.6625 13.75 12.25 13.75H1.75ZM1.75 1.75V12.25H12.25V1.75H10.75V7L8.875 5.875L7 7V1.75H1.75Z"
                  fill="white"
                />
              </svg>
              Resources
